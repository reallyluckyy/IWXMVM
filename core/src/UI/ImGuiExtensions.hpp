...
namespace ImGuiEx
{
    ...
    void DrawKeyframeSliderInternal(const char* label, uint32_t* currentTick, uint32_t* startTick, uint32_t* endTick,
                                    const std::vector<IWXMVM::Types::Keyframe>& keyframes);
}  // namespace ImGuiEx
