...
namespace IWXMVM::UI
{
	...
	void Background::Render()
	{
		...
		ImGui::Begin("Background", &p_open, ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoInputs | ImGuiWindowFlags_NoBringToFrontOnFocus);
