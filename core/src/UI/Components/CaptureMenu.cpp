...
namespace IWXMVM::UI
{
    ...
    void CaptureMenu::Render()
    {
        ...
        if (ImGui::Begin("Capture", NULL, flags))
        {
            ...
            ImGui::Combo("##captureMenuCameraCombo", &currentCameraComboItem, cameraComboItems,
                         IM_ARRAYSIZE(cameraComboItems));
            ...
            ImGui::Combo("##captureMenuOutputFormatCombo", &currentOutputFormatComboItem, outputFormatComboItems,
                         IM_ARRAYSIZE(outputFormatComboItems));
            ...
            ImGui::SetNextItemWidth(200);
            ImGui::Combo("##captureMenuResolutionCombo", &currentResolutionComboItem, resolutionComboItems,
                         IM_ARRAYSIZE(resolutionComboItems));
            ...
            ImGui::SetNextItemWidth(200);
            ImGui::Combo("##captureMenuFramerateCombo", &currentFramerateComboItem, framerateComboItems,
                         IM_ARRAYSIZE(framerateComboItems));
