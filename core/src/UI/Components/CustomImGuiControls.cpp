...
namespace ImGui
{
	...
	bool TimescaleSlider(const char* label, float* v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
	{
		auto ClampValue = [](void* p_data) 
		{
			...
			static constexpr std::array TIMESCALE_STEPS{ 0.001, 0.002, 0.005, 0.01, 0.02, 0.025, 0.05, 0.075, 0.1, 0.125, 0.2, 0.25, 0.333, 0.5, 0.75, 1.0, 1.25, 1.5, 2.0, 5.0, 10.0, 20.0, 50.0, 100.0, 500.0, 1000.0 };
