...
namespace IWXMVM::Components
{
    ...
    void OrbitCamera::DrawGrid()
    {
        ...
        {
            DrawLine(this, glm::vec3(-GLOBAL_AXIS_LENGTH, i, 0), glm::vec3(GLOBAL_AXIS_LENGTH, i, 0), SECONDARY_COLOR,
                     3);
            DrawLine(this, glm::vec3(i, -GLOBAL_AXIS_LENGTH, 0), glm::vec3(i, GLOBAL_AXIS_LENGTH, 0), SECONDARY_COLOR,
                     3);
        }
    }
    ...
    void OrbitCamera::DrawOrbitPoint()
    {
        ...
        DrawLine(this, orbitCameraOrigin - glm::vec3(AXIS_LENGTH, 0, 0),
                 orbitCameraOrigin + glm::vec3(AXIS_LENGTH, 0, 0), ImVec4(1.0f, 0.0f, 0.0f, 0.8f), 5);
        DrawLine(this, orbitCameraOrigin - glm::vec3(0, AXIS_LENGTH, 0),
                 orbitCameraOrigin + glm::vec3(0, AXIS_LENGTH, 0), ImVec4(0.0f, 1.0f, 0.0f, 0.8f), 5);
        DrawLine(this, orbitCameraOrigin - glm::vec3(0, 0, AXIS_LENGTH),
