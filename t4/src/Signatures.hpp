...
#define Lambda IWXMVM::Signatures::Lambdas
        ...
        // TODO: Sig("5C 24 38 55 8B 6C 24 40 57 8B F9", GAType::Code, -5) > CG_DObjGetWorldBoneMatrix;
        ...
        Sig("A1 ?? ?? ?? ?? 8B 08 8B 51 68", GAType::Data, 1) > d3d9DevicePointer; // TODO: do we not need Lambda::DereferenceAddress here?
        ...
        // TODO: Sig("E8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 83 F8 0E 0F 87", GAType::Code, 5) > CG_ProcessEntity;
        ...
        // TODO: Sig("83 C4 2C 5D 5B 59", GAType::Code, -5) > CG_DrawPlayerLowHealthOverlay;
        // TODO: Sig("0F 84 C9 00 00 00 8B 81 FC 03 05 00", GAType::Code, -7) > CG_DrawFlashDamage;
        // TODO: Sig("53 56 57 0F 84 EE 01 00 00", GAType::Code, -10) > CG_DrawDamageDirectionIndicators;
