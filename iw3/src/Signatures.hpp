...
#define Lambda IWXMVM::Signatures::Lambdas
    ...
    Sig("85 C0 74 ?? 8B FE E8 ?? ?? ?? ?? 8B 0D ?? ?? ?? ?? D9 41 ?? D8 4C 24 0C D9 5E 0C 5F 5E C3", GAType::Code, -5,
        Lambda::FollowCodeFlow) > Dvar_FindMalleableVar;
    ...
    Sig("05 ?? ?? ?? ?? B9 01 00 00 00 01 88 B8 56 02 00", GAType::Data, 1, Lambda::DereferenceAddress) > clientActive;
